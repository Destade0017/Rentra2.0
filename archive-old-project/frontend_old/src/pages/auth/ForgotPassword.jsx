        ...
        <div className="relative z-10 w-full max-w-md mx-auto">
          ...
          {!submitted ? (
            ...
            >
              ...
              {resetUrl && (
                <div className="mb-8 p-4 bg-slate-50 border border-slate-100 rounded-xl text-left">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Development Mode Link</p>
                  <a 
                    href={resetUrl} 
                    className="text-brand-500 font-medium text-xs break-all hover:underline"
                  >
                    {resetUrl}
                  </a>
                  <p className="mt-2 text-[10px] text-slate-400 italic">
                    This link is shown only for testing purposes since email service might not be configured.
                  </p>
                </div>
              )}
